              ...
              {customers.map((c, index) => {
                ...
                return (
                  <>
                    ...
                    {isSelected && (
                      <tr key={`${id}-detail`} className="customer-detail-row">
                        <td colSpan="6">
                          <div className="customer-detail">
                            {detailLoading ? (
                              ...
                              <div className="customer-detail-content">
                                <div className="detail-section">
                                  ...
                                  <div className="detail-grid">
                                    ...
                                    <div><strong>Teléfono:</strong> {customerDetail.phone || '—'}</div>
                              ...
                              <p style={{ padding: '16px', color: 'var(--text-muted)' }}>No se pudieron cargar los detalles</p>
                            )}
                          </div>
                        </td>
                      </tr>
